    ...
    private static Interceptor addCacheInterceptor() {
        Interceptor cacheInterceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                if (!NetworkUtil.isNetworkAvailable(ToolApplication.getContext())) {
        ...
        if (retrofit == null) {
            synchronized (Http.class) {
                if (retrofit == null) {
                    ...
                    //设置 请求的缓存的大小跟位置
                    File cacheFile = new File(ToolApplication.getContext().getCacheDir(), "cache");
                    ...
                    retrofit = new Retrofit
                            .Builder()
                            .baseUrl(HttpService.BASE_URL)  //自己配置
                            .client(client)
