...
//            LogUtils.e("xing",ex.message);
            return ex;
        } else if (e instanceof JSONException
                || e instanceof ParseException || e instanceof JsonSyntaxException) {
            ...
            return ex;
                ...
                instanceof ConnectTimeoutException || e instanceof UnknownHostException) {
